<div class="card">
  <div class="card-body d-flex pt-4">
    <div class="col-3 pe-2">
      <div class="mb-3">
        <h6 class="card-subtitle text-muted mb-1">Quotation Name</h6>
        <h2 class="card-subtitle">{{ $project->title }}</h2>
      </div>
      <div>
        @can('update', $project)
          <x-buttons.anchor :href="route('projects.edit', $project)" content="Edit Quotation" size="small" color="warning" class="my-1" />
        @endcan
        @can('delete', $project)
          <x-buttons.form :action="route('projects.destroy', $project)" content="Delete Quotation" size="small" color="danger" class="my-1" />
        @endcan
      </div>
    </div>
    <div class="col-2 px-3">
      ...
      <div class="align-bottom">
        <h6 class="card-subtitle text-muted mb-1">Lead</h6>
        <h6 class="card-subtitle">
    ...
    <div class="col-2 px-3">
      ...
      <div class="mb-3">
        <h6 class="card-subtitle text-muted mb-1">Next Follow-Up Date</h6>
