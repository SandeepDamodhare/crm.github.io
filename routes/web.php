...
use App\Http\Controllers\Task\TaskDescriptionController;
...
Route::middleware('auth')->group(function() {
    ...
    Route::resource('organizations.users', OrganizationUserController::class)->only(['index']);
    ...
    Route::resource('tasks.descriptions', TaskdescriptionController::class)->only(['index', 'store']);
